...
description-meta: "Research with Hongmou Zhang using anonymized location-based social-network data to examine city clusters and regional boundaries in China."
date: "Mar 2015"
...
author:
  ...
  - name: Pensen Wang
  - name: Jinhua Zhao
categories: [Collaborative Research, Mobility Data, Geospatial Analysis, Regional Planning]
...
**Research collaboration with Hongmou Zhang**<br>
My role: Lead analyst responsible for geospatial analysis, network analysis, and visualization. Working with Hongmou Zhang, Pensen Wang, and Jinhua Zhao, we examined regional structure using Tencent mobility data. The research began in 2015 and led to a peer-reviewed article published in 2026.
:::
